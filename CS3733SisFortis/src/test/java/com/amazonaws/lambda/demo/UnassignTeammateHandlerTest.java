...
import com.amazonaws.lambda.http.UnassignTeammateRequest;
import com.amazonaws.lambda.http.UnassignTeammateResponse;
import com.amazonaws.lambda.unassignTeammateHandler.UnassignTeammateHandler;
import com.amazonaws.lamda.assignTeammateHandler.AssignTeammateHandler;
	...
	public class UnassignTeammateHandlerTest extends LambdaTest{
	    ...
	    void testInput(String incoming, String outgoing) throws IOException {
	    	...
	    	UnassignTeammateResponse response = handler.handleRequest(req, createContext("Un-assign Teammate"));
	    ...
	    @Test 
	    public void testUnAssignTeammate() {
	    	String SAMPLE_INPUT = "{\"idTask\": \"2\", \"teammateName\": \"test\", \"idProject\": \"abc\"}";
	    	String RESULT = "test";
